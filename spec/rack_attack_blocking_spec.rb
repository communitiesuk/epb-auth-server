describe "Rack::Attack" do
  ...
  describe "block permanently blocked IP addresses" do
    ...
    context "when the 1st entry in x-forwarded-for is first in the blacklist" do
      before do
    ...
    context "when the 1st entry in x-forwarded-for is last in the blacklist" do
      before do
        header "X_FORWARDED_FOR", "198.53.120.110, 127.0.0.1, 198.51.100.200"
        Rack::Attack.enabled = true
      end
